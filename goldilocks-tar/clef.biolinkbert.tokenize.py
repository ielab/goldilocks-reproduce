...
path_or_name = [('michiyasunaga/BioLinkBERT-base', 'biolink_bert-base')]
...
for t_dir in tqdm(topics_dir):
    ...
    for name, outname in path_or_name:
        ...
        full_ds.save_encoded_features(gzip.open(f'./cache_new/clef_biolink/{run_name}_{outname}.512.pkl.gz', 'wb') )
