...
def main(args):
    ...
    # main logic
    for dataset, topic, qsname in product(args.dataset, args.topic, args.sampling_strategy):
        tag = f"{dataset}_{topic}_{args.iseed}_{qsname}"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, nargs='+', default=['clef17_test'])
    ...
    parser.add_argument('--cached_dataset', type=Path, default='./clef_info/lr_features/clef2017_test_CD007431_features.pkl')
    parser.add_argument('--train_epochs', type=int, default=20)
    parser.add_argument('--train_only_on_new', action='store_true', default=False)
    parser.add_argument('--disable_tqdm', action='store_true', default=False)

    parser.add_argument('--dataset_path', type=Path, default='./clef_info/2017/test/CD007431')

    parser.add_argument('--output_path', type=Path, default='./results/baseline/clef')
